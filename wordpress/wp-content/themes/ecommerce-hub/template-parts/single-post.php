...
<article>
	<h1><?php the_title(); ?></h1>
	<?php if( get_theme_mod( 'ecommerce_hub_single_post_date',true) != '' || get_theme_mod( 'ecommerce_hub_single_post_author',true) != '' || get_theme_mod( 'ecommerce_hub_single_post_comment_no',true) != '') { ?>
